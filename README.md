# PHP-FPM Lumen API with PostgreSQL

A simple PHP-FPM Lumen API application and PostgreSQL, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_php_lumen_fpm_nginx_postgresql.git
```

### 2. Navigate to Project Directory
```bash
cd api_php_lumen_fpm_nginx_postgresql
```
